...
def writeDoc(name, text):
    path = 'C:/Users/ivanj/Desktop/Output/' + name
    f = open(path, "a")
    f.truncate(0)
    f.write(text)
    f.close()
...
def downloadPhoto(link):
    ...
    open('C:/Users/ivanj/Desktop/Output/image.jpg', 'wb').truncate(0)
    with open('C:/Users/ivanj/Desktop/Output/image.jpg', 'wb') as handler:
        handler.write(img_data)

class Handler (FileSystemEventHandler):
    def on_modified(self, event):
    
        data = open(inputFile, "r", encoding='utf-8').read().split('|')
...
inputFolder = 'C:/Users/ivanj/Documents/Nightbot'
